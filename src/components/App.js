...
import DisplapComponent from "./displapComponent";
...
function App() {
  ...
  const [output,Setoutput] = useState(rawData)
  ...
  function breakfastBtn (){
    let temp = rawData.filter((item)=>item.category == "breakfast")
    Setoutput(temp);
  }
  function lunchBtn (){
    let temp = rawData.filter((item)=>item.category == "lunch")
    Setoutput(temp);
  }
  function shakesBtn (){
    let temp = rawData.filter((item)=>item.category == "shakes")
    Setoutput(temp);
  }
  ...
  return (
    ...
    <DisplapComponent output = {output}></DisplapComponent>
